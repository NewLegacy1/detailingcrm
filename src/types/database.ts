...
export interface Organization {
  ...
  website?: string | null
  /** Pro only: when true, multi-location booking and Locations admin are available. */
...
export interface Client {
  ...
  created_at: string
  org_id?: string | null
  /** Stripe Customer ID on org connected account (set when card saved at booking). Used for on-site checkout. */
...
export interface Job {
  ...
  paid_at?: string | null
  /** Multi-location (Pro): which location this job is at; null = legacy/single-location. */
  location_id?: string | null
}
