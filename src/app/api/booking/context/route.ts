...
export async function GET(req: NextRequest) {
  ...
  const isStarter = org.subscription_plan === 'starter'
  ...
  return NextResponse.json({
    businessName,
    logoUrl: isStarter ? '/detailopslogo.png' : (org.logo_url ?? null),
    primaryColor: isStarter ? null : (org.primary_color ?? null),
    accentColor: isStarter ? null : (org.accent_color ?? null),
