/**
 * HTML email template for review follow-up ("How was your experience?").
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 560px; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.07);">
          ...
          <tr>
            <td style="background-color: ${escapeHtml(accent)}; padding: 20px 32px;">
              <p style="margin: 0; font-size: 11px; font-weight: 700; color: ${escapeHtml(headerText)}; opacity: 0.85; letter-spacing: 1.2px; text-transform: uppercase;">We'd love your feedback</p>
              <h1 style="margin: 4px 0 0; font-size: 20px; font-weight: 700; color: ${escapeHtml(headerText)};">How was your experience? ⭐</h1>
            </td>
          </tr>
          <tr>
            <td style="background-color: #ffffff; padding: 28px 32px;">
              <p style="margin: 0 0 20px; font-size: 15px; color: #374151; line-height: 1.6;">
                Hi <strong>${escapeHtml(customerName)}</strong>, thanks for choosing <strong>${escapeHtml(businessName)}</strong>. Your opinion helps us keep raising the bar.
              </p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin: 24px 0;">
                <tr>
                  <td align="center">
                    <a href="${escapeHtml(reviewUrl)}" style="display: inline-block; background-color: ${escapeHtml(accent)}; color: ${escapeHtml(headerText)}; text-decoration: none; font-weight: 700; font-size: 16px; padding: 14px 32px; border-radius: 8px;">Leave a review</a>
                  </td>
                </tr>
              </table>
              <p style="margin: 0; font-size: 14px; color: #6b7280;">It only takes a moment — we really appreciate it.</p>
