-- Extend public booking context: per-service size_prices + org scheduling (hours, blackouts, timezone, slot interval)
...
comment on function public.get_public_booking_context is 'Returns public booking page context by booking_slug (org, profile, services with size_prices, scheduling settings). Anon may execute.';
