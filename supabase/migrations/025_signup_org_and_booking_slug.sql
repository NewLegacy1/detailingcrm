-- New signups get their own organization with booking_slug derived from business name
...
begin
  ...
  -- Clean to slug: lowercase first (keep letters), then spaces to hyphens, strip other special chars (e.g. "ShowRoom AutoCare" -> "showroom-autocare")
...
comment on function public.handle_new_user is 'On signup: create org with booking_slug from cleaned business name, create profile as owner.';
