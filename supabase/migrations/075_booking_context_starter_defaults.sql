-- Starter plan: booking page uses default colours and DetailOps logo; org name still shown.
...
comment on function public.get_public_booking_context(text) is 'Returns public booking context. Starter plan: default colours and DetailOps logo; org name still shown.';
