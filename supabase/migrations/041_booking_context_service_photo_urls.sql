-- Include service photo_urls in public booking context so booking page can display service images
...
comment on function public.get_public_booking_context is 'Returns public booking page context by booking_slug (org, profile, services with photo_urls and size_prices, upsells, scheduling). Anon may execute.';
