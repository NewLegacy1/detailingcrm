-- Expose map_theme in get_public_booking_context so booking page light/dark works.
...
comment on function public.get_public_booking_context is 'Returns public booking page context by booking_slug. Includes theme, mapTheme, serviceAreaLabel and bookingPaymentMode when Pro.';
