-- Expose booking_service_area_label (city/area name) in public booking context for header review line.
...
comment on function public.get_public_booking_context is 'Returns public booking page context by booking_slug. Includes serviceAreaLabel (city/area for header) and bookingPaymentMode when Pro.';
