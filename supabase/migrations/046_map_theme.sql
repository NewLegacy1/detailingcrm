-- Add map_theme column to organisations and expose it via booking context RPC

alter table public.organizations
  add column if not exists map_theme text default 'dark';

-- Update the booking context function to return mapTheme
...
comment on function public.get_public_booking_context is 'Returns public booking page context by booking_slug (includes mapTheme for dark/light map styles).';
