-- Expose service_radius_km in get_public_booking_context so the booking page can validate address is within service area.
...
comment on function public.get_public_booking_context is 'Returns public booking page context. Includes serviceRadiusKm for service area validation, mapLat/mapLng, theme, bookingPaymentMode when Pro.';
