-- Expose booking_text_color in get_public_booking_context so custom text colour works on the booking page.
...
comment on function public.get_public_booking_context is 'Returns public booking page context by booking_slug. Includes theme, mapTheme, bookingTextColor, serviceAreaLabel and bookingPaymentMode when Pro.';
